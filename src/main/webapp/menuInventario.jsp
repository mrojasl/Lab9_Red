...
<div class="container">
    ...
    <%if(mostrar){%>
        ...
        <div class="alert alert-success alert-dismissible fade show d-flex align-items-center" role="alert">
            ...
            <div>
                Se añadió el objeto exitosamente!
            </div>
    ...
    <div class="alert alert-danger" role="alert">
        <h4 class="alert-heading">El inventario está vacío</h4>
        <p>Cuando un superviviente es creado por primera vez, este empieza con el inventario vacío. También, cuando
            los zombies se convierten en supervivientes, estos comienzan sin objeto alguno.</p>
        <hr>
        <p class="mb-0">Para añadir un objeto al superviviente presiona "Añadir Objeto"!</p>
    </div>
    <%}%>
</div>
