...
<jsp:useBean id="listaSupervivientes" scope="request" type="java.util.ArrayList<pe.edu.pucp.lab9_red.beans.Superviviente>"/>
<jsp:useBean id="listaZombies" scope="request" type="java.util.ArrayList<pe.edu.pucp.lab9_red.beans.Zombie>"/>
...
<div class="container">
    ...
    <!--ALERTA DE OBJETO AÑADIDO O SI ERA MUY PESADO-->
    <!--ALERTA DE OBJETO AÑADIDO O SI ERA MUY PESADO-->
    <%if(mostrar){%>
    <%if(exitoso){%>
    <div class="alert alert-success alert-dismissible fade show d-flex align-items-center" role="alert">
        ...
        <div>
            El Superviviente ganó! El Zombie se convirtió en un humano soltero.
        </div>
    ...
    <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center" role="alert">
        ...
        <div>
            El Zombie ganó! El Superviviente se convirtió en un zombie de la misma variante.
        </div>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
    <%}%>
    ...
    <div class="row">
        <table class="table table-hover table-danger" style="margin-top: 5px">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-outline-danger"  data-bs-toggle="modal" data-bs-target="#extraLargeModal<%=z.getIdHumano()%>" > Seleccionar Víctima </button>
                </td>
            </tr>
            <%}%>
            </tbody>
...
<%for(Zombie z:listaZombies){%>
<div class="modal fade" id="extraLargeModal<%=z.getIdHumano()%>" tabindex="-1" role="dialog" >
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <table class="table table-hover table-dark" style="margin-top: 5px">
                        ...
                        <tbody>
                        <%for(Superviviente sp: listaSupervivientes){%>
                        <form method="POST" action="<%=request.getContextPath()%>/?action=Atacarhumano">
                        <input type="hidden" name="idZombie" value="<%=z.getIdHumano()%>">
                        <input type="hidden" name="idSuper" value="<%=sp.getIdHumano()%>">
                        <tr>
                            <td><%=sp.getIdHumano()%></td>
                            <td><%=sp.getNombre()+" "+sp.getApellido()%></td>
