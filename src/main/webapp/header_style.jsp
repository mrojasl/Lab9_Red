...
<nav class="navbar navbar-light" style="background:#484f4f;">
    ...
    <div class="nav2">
        <a href="<%=request.getContextPath()+"/?action=Supervivientes"%>" class="my-1 mx-1"><button type="button" class="btn btn-outline-info">   Humanos <i class="bi bi-person-badge-fill"></i>️</button> </a>
        <a href="#" class="my-1 mx-1"><button type="button" class="btn btn-outline-success"> Supervivientes <i class="bi bi-person-heart"></i>️</button> </a>
