    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content" STYLE="background-color: rgb(157,138,142)">
            <div class="modal-header" STYLE="background-color: rgb(157,138,142)">
                <h5 class="modal-title" id="exampleModalLabel"><p STYLE="color: white;font-size: 30px"> <strong>Añadir Variante</strong></p></h5>
                                        ...
                                        <div class="col-lg-5" STYLE="background-color: rgb(157,138,142)">
                                            <div class="row px-2" STYLE="background-color: rgb(157,138,142)" >
                                                <div class="form-group col-md-6">
                                                    <label for="nvirus" ><strong style="color: black">Virus al que pertenece</strong></label> <input type="text" class="form-control" id="nvirus" name="nvirus" required="required" placeholder="Virus">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="nvariante"><strong style="color: black">Nombre de la variante</strong></label> <input type="text" class="form-control" id="nvariante" name="nvariante" required="required" placeholder="Variante">
                                                </div>
                                            </div>
                                        </div>
